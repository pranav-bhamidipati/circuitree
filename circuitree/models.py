...
class SimpleNetworkMixin:
    """A mixin class for simple network circuits. Can be combined with the CircuiTree or
    MultithreadedCircuiTree base classes."""
...
class SimpleNetworkTree(SimpleNetworkMixin, CircuiTree):
    """
    SimpleNetworkTree
    =================
